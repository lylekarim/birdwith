...
class Detail extends Component {
    ...
    render() {
        ...
        const replytext = "Click here to reply to https://enigmatic-taiga-42636.herokuapp.com/" + this.state.logintoken;
        // email.text = replytext + "Click here to reply to https://enigmatic-taiga-42636.herokuapp.com/" + this.state.logintoken;

        //email.text = replytext;
                            ...
                            <div className="col-md-8">
                                ...
                                <div className="comment-respond">
                                    ...
                                    <form method="get" className="comment-form">
                                        ...
                                        <div className="form-group">
                                            <label>Message:</label>
                                            <textarea key={replytext} defaultValue={replytext + email.text} placeholder="Message" className="form-control" rows={3} style={textArea}
